...
if st.button("Predict"):
    ...
    if prediction==1:
        st.error("⚠️ You are at risk of heart stroke. Please consult a doctor. 🧑‍⚕️🧑‍⚕️🧑‍⚕️")
    else:
        st.success("✅ You are not at risk of heart stroke. Keep maintaining a healthy lifestyle.")